namespace RSMEnterpriseIntegrationsAPI.Application.Services
{
    ...
    public class SalesOrderHeaderService : ISalesOrderHeaderService
    {
        ...
        public async Task<int> UpdateSalesOrderHeader(UpdateSalesOrderHeaderDto saleOrderHeaderDto)
        {
            ...
            var saleOrderHeader = await ValidateSalesOrderHeaderExistence(saleOrderHeaderDto.SalesOrderId);
            
            saleOrderHeader.RevisionNumber = saleOrderHeaderDto.RevisionNumber;
            //saleOrderHeader.BillToAddressID = saleOrderHeaderDto.BillToAddressID;
            ...
            //saleOrderHeader.ShipToAddressID = saleOrderHeaderDto.ShipToAddressID;
