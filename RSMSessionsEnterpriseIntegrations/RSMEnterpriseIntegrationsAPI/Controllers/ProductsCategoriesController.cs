namespace RSMEnterpriseIntegrationsAPI.Controllers
{
    ...
    public class ProductsCategoriesController : ControllerBase
    {
        ...
        public ProductsCategoriesController(IProductCategoryService service)
        {
            _service = service;
        }
        ...
        [HttpPost("Create")]
        public async Task<IActionResult> Create(CreateProductCateDto dto)
        {
            return Ok(await _service.CreateProductCategory(dto));
        }

        [HttpPut("Update")]
        public async Task<IActionResult> Update(UpdateProductCateDto dto)
        {
